...
class TestSubjectModel:
    def test_create_platform_global_subject(self, db):
        subject = Subject.objects.create(
            name='Matematika', slug='matematika', description='Asosiy matematika kursi'
        )
    ...
    def test_create_tenant_specific_subject(self, db, org):
        subject = Subject.objects.create(
            name='Xususiy Matematika', slug='xususiy-matematika', organization=org
        )
...
class TestQuestionModel:
    ...
    def test_question_has_all_types(self, db, org):
        ...
        for qtype in types:
            with tenant_context(org):
                q = Question.objects.create(organization=org, subject=subject, type=qtype)
            assert q.type == qtype
    ...
    def test_question_with_topic_and_tags(self, db, org):
        ...
        with tenant_context(org):
            question = Question.objects.create(organization=org, subject=subject, topic=topic)
    ...
    def test_question_multilingual_support(self, db, org):
        ...
        with tenant_context(org):
            q_uz = Question.objects.create(organization=org, subject=subject, language='uz')
            q_en = Question.objects.create(
                organization=org, subject=subject, language='en', parent_question=q_uz
            )
    ...
    def test_question_irt_parameters(self, db, org):
        ...
        with tenant_context(org):
            q = Question.objects.create(
                organization=org, subject=subject, difficulty_index=1.5, discrimination_index=0.8
            )
    ...
    def test_question_shuffling_enabled(self, db, org):
        ...
        with tenant_context(org):
            q = Question.objects.create(organization=org, subject=subject, shuffling_enabled=True)
...
class TestQuestionVersion:
    def test_create_question_version(self, db, org):
        ...
        with tenant_context(org):
            ...
            v1 = QuestionVersion.objects.create(
                question=q,
                version_number=1,
                content={'text': '2 + 2 = ?', 'latex': '2 \\plus 2 = ?', 'media': []},
                options=[
    ...
    def test_version_unique_together(self, db, org):
        ...
        with tenant_context(org):
            q = Question.objects.create(organization=org, subject=subject)
            QuestionVersion.objects.create(question=q, version_number=1, content={}, options=[])
    ...
    def test_question_versions_ordered_by_version_number(self, db, org):
        ...
        with tenant_context(org):
            ...
            v2 = QuestionVersion.objects.create(
                question=q, version_number=2, content={}, options=[]
            )
            v1 = QuestionVersion.objects.create(
                question=q, version_number=1, content={}, options=[]
            )
            v3 = QuestionVersion.objects.create(
                question=q, version_number=3, content={}, options=[]
            )
...
class TestQuestionBank:
    def test_create_public_question_bank(self, db, org):
        bank = QuestionBank.objects.create(
            organization=org, name='Platform DTM', slug='platform-dtm', is_public=True
        )
    ...
    def test_create_private_tenant_bank(self, db, org):
        with tenant_context(org):
            bank = QuestionBank.objects.create(
                organization=org, name='Private Bank', slug='private-bank', is_public=False
            )
    ...
    def test_question_bank_with_multiple_questions(self, db, org):
        ...
        with tenant_context(org):
            ...
            bank = QuestionBank.objects.create(organization=org, name='Bank', slug='bank')
    ...
    def test_question_bank_str_representation(self, db, org):
        with tenant_context(org):
            bank = QuestionBank.objects.create(organization=org, name='My Bank', slug='my-bank')
...
class TestImportBatch:
    def test_create_import_batch(self, db, org, user):
        with tenant_context(org):
            batch = ImportBatch.objects.create(organization=org, file_type='xlsx', created_by=user)
    ...
    def test_import_batch_with_error_log(self, db, org, user):
        with tenant_context(org):
            batch = ImportBatch.objects.create(
                organization=org, file_type='xlsx', created_by=user, error_log=['Xato 1', 'Xato 2']
            )
