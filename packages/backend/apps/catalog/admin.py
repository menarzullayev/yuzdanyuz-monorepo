...
from .models import (
    Subject, Topic, Tag,
    Question, QuestionVersion, QuestionBank,
    ImportBatch, QuestionDraft,
    AIProviderConfig,
)
...
class AIProviderConfigAdmin(admin.ModelAdmin):
    list_display       = ('priority', 'name', 'provider_badge', 'model', 'use_for', 'status_badge', 'updated_at')
...
class QuestionAdmin(admin.ModelAdmin):
    list_display  = ('id', 'type', 'subject', 'language', 'initial_difficulty', 'is_active', 'created_at')
